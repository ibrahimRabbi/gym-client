...
const Category = () => {
    const categories = [
        ...
        { name: 'Leg Extention', src: 'https://i.ibb.co/7gCm9Kk/Body-Solid-DLEC-SF-Pro-Dual-Leg-Extension-Curl-Machine-Fitness-Superstore.jpg' },
    ...
    return (
        <div className="mt-20 w-[95%] mx-auto ">
            ...
            <div className=" mt-7 grid grid-cols-5 gap-x-8 gap-y-14">
                {
                    categories.map(v => {
                        return <div className="hover:rotate-3 duration-100 cursor-pointer">
