    ...
    return (
        <div className='border rounded-lg h-96 lg:sticky p-5 top-28'>
            ...
            <div className='mt-5 text-zinc-950 text-sm'>
                ...
                <Link to='/place-order' state={{subTotal,items:data}} className='bg-zinc-950 mt-16 block   p-2 text-center font-semibold text-white text-sm rounded-lg w-full'>proceed to Checkout</Link>
            </div>
        </div>
